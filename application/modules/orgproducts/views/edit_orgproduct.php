		 ...
		 foreach ($nondependable as $k=>$v)
				   ...
				   <?php } ?>
										...
										<div class="col-12 col-lg-6 text-right">
											<br>
											<button class="btn btn-main-primary pd-x-20 mg-t-10" type="submit">&nbsp;&nbsp;&nbsp;UPDATE&nbsp;&nbsp;&nbsp;        </button>    <a href="<?php echo base_url()?>orgproducts/orgproduct_list" role="button" class="btn btn-dark pd-x-20 mg-t-10">Cancel</a>      
