...
<!-- main-content opened -->
    ...
    <!-- main-content-body -->
            ...
            <div class="card mg-b-20">
              <div class="card-header pb-0">
                <div class="justify-content-between" style="display: inline-block;">
                  <h3 class="card-title mg-b-2 mt-2"> Product(New Estimate)</h3>
          ...
          <div class="card-body">                
               <form role="form" action="<?php echo base_url()?>estimate/new_cart"  method="post" enctype="multipart/form-data" id="orgproducts">
      ...
      <div class="col-lg-12 d-md-flex justify-content-md-between align-items-center bor_bot">
          ...
          <a class="btn mt-md-0 mt-3 conti_shop" href="<?php echo base_url()?>estimate/product_select" >Continue Product Add</a>
        </div>  
      </div>
  ...
  <?php echo $items['qty']?>
        ...
        <div class="edit_delete">
          ...
          <?php if($countcart!="1"){?>
              ...
              <a href="<?php echo base_url()?>estimate/newcart_delete/<?php echo $items['admin_cart_id']?>" class="Delete_class"  onClick="return confirm('Are you sure you want to delete this item')"><i class="typcn typcn-delete"></i> Delete</a>
                <?php } ?>
        </div>
          </div>
        ...
        <div class="col-md-4 col-lg-4">   
          <div class="cart_summary sticky_new">
              <div class="justify-content-md-between ">
                <h5 class="mb-0 head_sum"><b>Estimate Summary</b> </h5>
              </div>
              <div>
              <table class="table">
                            <tbody>
                                <tr>
                                    ...
                                    <input type="hidden" name="vat_price" id="vat_price" value="<?php echo $vat?>">
                                </tr>
                                <!--<tr>
                                ...
                                <tr>
                                    ...
                                    <td class="cart_total_amount" id="discount_disp">SAR&nbsp;<?php echo $discount?></td>
                                </tr>
                                <tr>
                                    <td class="cart_total_label">VAT (15%)</td>
                                    <td class="cart_total_amount" id="vat">SAR&nbsp;<?php echo $vat?></td>
                                </tr>
                                <tr>
                                    <td class="cart_total_label"><strong>Estimate Total </strong></td>
                                    <td class="cart_total_amount" id="total" style="font-weight:bold"><strong>SAR&nbsp;<?php echo number_format($grandtotal,2)?></strong></td>
                                    <input type="hidden" name="total_price" id="total_price" value="<?php echo $grandtotal?>">
                                </tr>
                                ...
                                <tr>
                                    <td class="cart_total_label"><strong>Estimate Discount </strong></td>
                                    <td class="cart_total_amount">(Amount/Percentage)</td>
                                </tr>
                                <tr>
                                    <td class="cart_total_label"><input type="text" name="discount" id="discount" placeholder="Enter Discount"></td>
                                    <td class="cart_total_label"><select class="" id="discount_type" name="discount_type">
             ...
             <div class="col-md-12">
                 ...
                 <div class="col-12 col-md-6">
                    ...
                    <div class="col-12 col-lg-6 text-right">
                      <br>
                      <button class="btn btn-main-primary pd-x-20 mg-t-10" type="submit" id="createorder">Create Estimate</button>         
...
$('#customerid').on('change', function() {
      ...
      var customer_id = $('#customerid').val();
			...
			//alert(customer_id);
			 ...
			 $.ajax({  
                    url: "<?php echo base_url(); ?>estimate/update_shipping/", //The url where the server req would we made.
                    async: false,
      ...
      var customer_id = $('#customerid').val();
			...
			//alert(customer_id);
			 ...
			 $.ajax({  
                    url: "<?php echo base_url(); ?>estimate/update_billing/", //The url where the server req would we made.
                    async: false,
                    type: "POST", //The type which you want to use: GET/POST
                   // data: $(deyar_form).serialize(),//The variables which are going.
                    data:{customer:customer_id},
 ...
 $('#discount_type').on('change', function() {
     ...
     var disc=  $("#discount").val();
      ...
      $("#vat").html("SAR "+vat);
       ...
       var discounttotal=$("#discount_val").val();
       //alert(discounttotal);

       var subtotal=$("#subtotal").val();
       //alert(subtotal);

       var vatprice=$("#vat_price").val();
       //alert(vatprice);
      
      var total=parseFloat(subtotal)+parseFloat(vatprice)-parseFloat(discounttotal);
      
     total=parseFloat(total).toFixed(2);

     $("#total_price").val(total);

     var totalprice="SAR "+total;
