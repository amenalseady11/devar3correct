					...
					<div class="col-xl-12">
						...
						<div class="card mg-b-20">
							<div class="card-header pb-0">
								...
								<form method="post" action="<?php echo base_url()?>ad_order/update_order_status">
									
									<input type="hidden" name="ordid" value="<?php echo $orderid?>">
									
							<div class="btn_right class_status" >
								Order Status : 
								<select id="update_statusbtn" name="status"> 
									...
									<span class=""><button type="submit" class="btn-primary">Update</button></span>
							</div>
									</form>
					                </div>
