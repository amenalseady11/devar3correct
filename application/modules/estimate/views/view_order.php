...
<!-- main-content opened -->
					...
					<div class="breadcrumb-header justify-content-between">
						<div>
							...
							<nav aria-label="breadcrumb">
								...
								<li class="breadcrumb-item active"><a href="<?php echo base_url()?>estimate">Estimate</a></li>
    ...
    <strong>Success!</strong> <?php echo $this->session->flashdata('message_email');?>
							...
							<div class="card-header pb-0">
								...
								<div class="justify-content-between" style="display: inline-block;"><a href="<?php echo base_url()?>estimate">back</a>
...
<div class="box box-address-billing">
              <div class="box-title">
                    <strong>Shipping Address</strong>&nbsp;&nbsp;<strong><a href="<?php echo base_url()?>estimate/shipping_update/<?php echo $shipping['id']?>">edit</a></strong>
                </div>
...
<div class="box box-address-billing">
              <div class="box-title">
                    <strong>Billing Address</strong>&nbsp;&nbsp;<strong><a href="<?php echo base_url()?>estimate/billing_update/<?php echo $billing['id']?>">edit</a></strong>
                </div>
                <div class="box-content order_vi">
                     <address>
				...
				foreach ($order_details as $items)
{
   ...
   <div class="show_hide">View More</div> <span class="editnew_btn"><a href="<?php echo base_url()?>estimate/edit_product_estimate/<?php echo $itemid?>">Edit</a></span>
         ...
         <td class="text-center">
         	...
         	<a href="<?php echo base_url()?>estimate/orditemdelete/<?php echo $itemid?>" data-placement="top" data-toggle="tooltip-primary" title="Delete" style="display: inline-block;" onclick="return confirm('Are you sure you want to delete this item?');"><button class="btn btn-danger btn-icon"><i class="typcn typcn-delete"></i></button></a>
			 <?php } ?>
         </td>
      </tr>
       <?php } 
...
<br>
						...
						<div class="row" align="right">
								...
								<button type="submit" class="btn btn-primary" style="width:230px; margin-bottom:100px;font-size: 18px;font-weight: 600;"><?php if($orders['confirmed']){?>Update Estimate<?php } else {?>Confirm Estimate<?php } ?></button>	
									 								
							   <div align="right" style="margin-left:200px"> <a class="btn btn-secondary" href="<?php echo base_url()?>estimate/emailpdf/<?php echo $orderid?>" role="button" style="width:230px; margin-bottom:100px;font-size: 18px;font-weight: 600;" >Send Estimate</a></div>
