						...
						<div class="card mg-b-20">
							...
							<div class="btn_right class_status" >
								...
								<select id="update_statusbtn" class="form-control2" name="status"> 
									...
									<span class=""><button type="submit" class="btn-primary update_status" id="upbutton">Update</button></span>
							</div>
									</form>
					                </div>
   ...
   <tfoot>
      ...
      <tr class="shipping">
         ...
         <td  class="amount" data-th="Shipping &amp; Handling" style="text-align: left;background-color: #f1f6fb;">
            <span class="price1" id="discountprice">SAR <?php echo $orders['discount']?><?php if($orders['discount_type']=="percentage"){ echo " (".$orders['discount_percentage']." %)"; }?></span>                    
         </td>
