<!-- main-content opened -->
		...
		<!-- main-content-body -->
					...
					<div class="card-body">                
               <form role="form" action="<?php echo base_url()?>estimate/product_select"  method="post" enctype="multipart/form-data" id="orgproducts">
									<div class="row ">
	...
	<?php	
										...
										<div class="col-12 col-lg-6 text-right">
											<br>
											<button class="btn btn-main-primary pd-x-20 mg-t-10" type="submit" id="newproduct">Create Estimate</button>         
