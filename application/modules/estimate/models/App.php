...
class App extends CI_Model
{
    ...
    function orderlisting()
    {
      ...
      $this->db->join('estimates as est', 'est.customer_id = cu.customer_id'); 
	 ...
	 function getorderdetails($ordid)
    {
		...
		$this->db->join('estimate_item', 'estimate_item.order_id = estimates.order_id');
		 $this->db->where('estimates.order_id',$ordid);
	 ...
	 function getitem($itemid)
    {
        ...
        $query = $this->db->get('estimate_files');
    ...
    {
        $this->db->where('order_id',$orderid);		 		
        $query = $this->db->get('customer_estimate_shipping_address');
    ...
    {
        $this->db->where('order_id',$orderid);		 		
        $query = $this->db->get('customer_estimate_billing_address');
	...
	function getorderitems($itemid)
    {
        ...
        $query = $this->db->get('estimate_item');
	...
	function deleteorderitem($itemid)
    {
		...
		$this->db->where('id',$itemid);       
        $query = $this->db->delete('estimate_item');
    ...
    function getshippingestimate($orderid)
    {
        $this->db->where('order_id',$orderid);		
        $query = $this->db->get('customer_estimate_shipping_address');
    ...
    function getbillingestimate($orderid)
    {
        $this->db->where('order_id',$orderid);		
        $query = $this->db->get('customer_estimate_billing_address');
