   ...
   <!--------end of non dependable attribute---------------------------------->
                        ...
                        <option value="2" <?php if(isset($result->status))if($result->status=="2") echo "selected";?>>InActive</option>
										...
										<div class="col-12 col-lg-6 text-right">
											<br>
											<button class="btn btn-main-primary pd-x-20 mg-t-10" type="submit" id="submit">Update Form</button>   <a href="<?php echo base_url()?>productsmap/productmap_list" role="button" class="btn btn-dark pd-x-20 mg-t-10">Cancel</a>                      </div>
							                </div>
								</form>
