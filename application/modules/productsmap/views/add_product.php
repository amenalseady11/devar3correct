              ...
              if(isset($result->product_id)){?>
	                                   ...
	                                   <div class="row ">
										<div class="col-12 col-lg-6">
											<div class="form-group mg-b-0">
												...
												<textarea  id="editor1" name="description"  class="form-control"><?php echo $result->description?></textarea>
                        ...
                        <option value="2" <?php if(isset($result->status))if($result->status=="2") echo "selected";?>>InActive</option>
										...
										<div class="col-12 col-lg-6 text-right">
											<br>
											<button class="btn btn-main-primary pd-x-20 mg-t-10" type="submit"><?php if(isset($result->product_id)){?>&nbsp;&nbsp;Update&nbsp;&nbsp;<?php } else{?>Submit Form <?php } ?></button>                </div>
							                </div>
								</form>
