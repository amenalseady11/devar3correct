<<!-- main-content opened -->
				...
				<div class="container">
					...
					<div class="col-xl-12">
						<div class="card mg-b-20">
							...
							<div class="btn_right">
								<a href="<?php echo base_url()?>customers/" class="btn btn-outline-success btn-block"> New Customer</a>
							</div>
					                </div>
							<div class="card-body">
    ...
    foreach ($customers as $cust) {
		$i=$i+1;
		if($cust->customer_status=="1"){$st="Active";$badge="primary";} else{$st="InActive";$badge="danger";}
        ?>
											<tr>
												<td><?php echo $i; ?></td>
												<td ><a href="#"><?php echo $cust->customer_firstname?>&nbsp;<?php echo $cust->customer_lastname?></a></td>
	...
	<a href="edit/<?php echo $cust->customer_id?>"><button class="btn btn-primary btn-icon"><i class="typcn typcn-edit"></i></button></a>
	<a href="delete/<?php echo $cust->customer_id?>" onClick="return confirm('Are you sure you want to delete this item')"><button class="btn btn-danger btn-icon"><i class="typcn typcn-delete"></i></button></a>
                </div>
												</td>
											</tr>
