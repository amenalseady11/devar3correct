					...
					<div class="breadcrumb-header justify-content-between">
						<div>
							...
							<nav aria-label="breadcrumb">
								...
								<li class="breadcrumb-item active"><a href="<?php echo base_url()?>ad_order">Orders</a></li>
					...
					<div class="col-xl-12">
						...
						<div class="card mg-b-20">
							<div class="card-header pb-0">
								<div class="justify-content-between" style="display: inline-block;"><a href="<?php echo base_url()?>ad_order" class="update_status">back</a>
							...
							<div class="btn_right class_status" >
								...
								<select id="update_statusbtn" class="form-control2" name="status"> 
									...
									<span class=""><button type="submit" class="btn-primary update_status pink_colorcss" id="upbutton">Update</button></span>
							</div>
									</form>
					                </div>
		 ...
		 <input type="hidden" name="orderid" value="<?php echo $orderid?>"> 
					 ...
					 <select class="discount_select  form-control" id="product" name="product">
						 ...
						 <?php } ?>
									  ...
									  <button type="submit" class="btn-primary pink_colorcss" style="float: right;display: inline-block;margin-bottom: 10px;" id="newitem">Add New  Item </button>
				...
				foreach ($order_details as $items)
{
   ...
   <div class="show_hide">View More</div> <span class="editnew_btn"><a href="<?php echo base_url()?>ad_order/edit_product_order/<?php echo $itemid?>">Edit</a></span>
         ...
         <td class=" qty" data-th="Qty">
           <form method="post" action="<?php echo base_url()?>ad_order/update_qty">
   ...
   <button class="update_btn pink_colorcss" type="submit" <?php if($items['type_price']=="1"){ echo "disabled";} ?>>Update</button>
			 </form>
  ...
  <div class="row">
                            ...
                            <div class="box_moreoptions">
                            	...
                            	<div class="row">
                            	 ...
                            	 <div>
									 <?php if($orders['discount_type']=="amount")
											{

                                             $discount=$orders['discount'];
											}
									 else if($orders['discount_type']=="percentage")
									 {
										 
										$discount=$orders['discount_percentage']; 
									 }
?>
									 
                            	 	<input type="text" name="discount" id="discount" value="<?php echo $discount?>" placeholder="Enter Discount" class="discount_input form-control" onChange="dis()">
                            	 	...
                            	 	Deposit
                            	 	 ...
                            	 	 <div>
										 ...
										 <?php if($orders['deposit_type']=="amount")
											{

                                             $deposit=$orders['deposit'];
											}
									 else if($orders['deposit_type']=="percentage")
									 {
										 
										$deposit=$orders['deposit_percentage']; 
									 }
?>
                            	 	<input type="text" name="deposit" id="deposit" value="<?php echo $deposit?>" placeholder="Enter Deposit" class="deposit_input form-control" onChange="dep()">
...
<br>
						...
						<div class="row">
							...
							<div style="width:230px;display: inline-block;margin-bottom:200px;margin-left:30px;">
									<?php if($orders['confirmed']=="0"){?>	
								<button type="submit" class="btn btn-primary btn-primary-bor" name="onhold" id="onhold" style="width: 100%; font-size: 15px;font-weight: 600;margin-bottom: 20px;">On Hold</button>
								<?php } ?>
								<button type="submit" id="confirm" class="btn btn-primary" style="width: 100%;font-size: 18px;font-weight: 600;margin-bottom: 100px;"><?php if($orders['confirmed']){?>Update Order<?php } else {?>Confirm Order<?php } ?></button>	
							</div>
									 <?php if($orders['confirmed']){?>								
							    <a class="btn btn-outline-success " href="<?php echo base_url()?>ad_order/payment_invoice_view/<?php echo $orders['order_id']?>" role="button" style="width:200px;margin-left:30px;margin-bottom:100px">Invoice</a>
								 <?php } ?>
								 
								  <?php if($orders['confirmed']){?>								
							    <button type="button" class="btn btn-primary" name="assignorder" id="assign_order" style="width:230px; margin-bottom:100px; margin-left:30px;font-size: 18px;font-weight: 600;">Assign Task</button>
								 <?php } ?>
...
<!--<td style="vertical-align: middle;"><a href="#"><span class="badge badge-primary-gradient">Pending </span></a></td>
  ...
  <a href="#" data-placement="top" data-toggle="tooltip-primary" title="View">  <button class="btn btn-success btn-warning  btn-icon" ><i class="typcn typcn-eye"></i></button></a>
	...
	<a href="#" data-placement="top" data-toggle="tooltip-primary" title="Delete"><button class="btn btn-danger btn-icon"><i class="typcn typcn-delete"></i></button></a>
		...
		<div id="assign_order_popup" class="modalstle" style="display: none;">
    <!-- Modal content -->
			
			
			
    <div class="modal-contentstyle" style="height:600px">
		<form method="post" action="<?php echo base_url()?>ad_order/assign_task" style="text-align: left;">
			<input type="hidden" name="assign_orderid" value="<?php echo $orderid?>">
        <div>
           <!--  <strong style="font-size: 16px;color: #21293C;"> </strong> <span class="close">�</span> -->
<div>
	
	<div class="form_css01">
		<div><b>Select Groups</b></div>
	<select class="discount_select  form-control" id="task" name="task[]" multiple style="width: 100%;margin: 0px 0px;">
		
						
						 <?php foreach ($groups as $prd){?>
	

										
                            	 		<option value="<?php echo $prd[group_id]?>"><?php echo $prd[group_name]?></option>
...
<div class="form_css01">
	...
	<textarea name="details" id="details" rows="2"  class="form-control"></textarea>
	</div>
<div class="form_css01">
...
<br>
		<div>
            ...
            <button type="submit" class="btn pinkcss animatedBtn darckBtn btn_style2 width175" name="assign_task" id="assign_task" style="width:175px">Assign Task</button>
			
			<a href="<?php echo base_url()?>ad_order/view_order/<?php echo $orderid?>" class="btn pinkcss animatedBtn darckBtn btn_style2 width175" style=""><span> Cancel</span></a>
		</div><br>
