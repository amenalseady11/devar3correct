						...
						<div class="card mg-b-20">
							<div class="card-header pb-0">
								<div class="justify-content-between" style="display: inline-block;">
									<h3 class="card-title mg-b-2 mt-2"> Orders List</h3>
    ...
    foreach ($orders as $ord) {		
		...
		$totalprice=$ord->price+$ord->shipping_price;
					   ...
					   ?>
											...
											<tr>
												<td><?php echo $i ?></td>
												<td><a href="<?php echo base_url()?>ad_order/view_order/<?php echo $ord->order_id?>" target="_blank">#<?php echo $ord->order_id ?></a></td>
...
<?php if($orderaccess['edit_access']=="1" || $type=="Admin"){?>
														
														
	<a href="ad_order/view_order/<?php echo $ord->order_id?>"><button class="btn btn-primary btn-icon"><i class="typcn typcn-edit"></i></button></a>	
														<?php } else {?>
						   
					 
														
	<a href="ad_order/view_order_version/<?php echo $ord->order_id?>"><button class="btn btn-primary btn-icon"><i class="typcn typcn-edit"></i></button></a>		
		<?php  } ?>												
		<?php if($orderaccess['delete_access']=="1" || $type=="Admin"){?>
	<a href="ad_order/delete/<?php echo $ord->order_id?>" onClick="return confirm('Are you sure you want to delete this item')"><button class="btn btn-danger btn-icon"><i class="typcn typcn-delete"></i></button></a>
	<?php } ?>
                </div>
												</td>
											</tr>
