        ...
        $this->load->library('form_validation');
				if($this -> ion_auth -> logged_in()==1)
				{
			       ...
			       $taskstr="";
					...
					$taskstr=substr($taskstr,0,strlen($taskstr)-1);
				    $orderid           = $this->input->post('assign_orderid');
					...
					$checkorder=$assigntask->gettaskorder($orderid);
				...
				$data              = array(
					...
					else
					{
						...
						$this->db->insert('order_tasks', $data);
					}
