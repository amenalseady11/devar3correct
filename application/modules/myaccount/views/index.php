  ...
  <div class="row">
     <div class="col-12">
      <br>
    <button type="submit" class="btn pinkcss animatedBtn darckBtn btn_style1">Update Profile</button>
            ...
            <div class="modal-dialog" role="document">
               <form method="POST" action="<?php echo base_url()?>Change_password" id="">
