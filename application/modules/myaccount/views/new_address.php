                  ...
                  <div class="col-md-8 col-lg-9">
                    <div class="box_address">
                       ...
                       <div>
                          <form class="g-3 acc_form" method="post" action="new_address">
							  
							    <div class="row">
               <div class="col-md-12">
    <label for="fname" class="form-label">First Name</label>
    <input type="text" class="form-control" id="firstname" name="firstname" placeholder="First Name"  value="<?php echo $accountinfo['customer_firstname']?>">
  </div>
  <div class="col-md-12 mar-b">
    <label for="lname" class="form-label">Last Name</label>
    <input type="text" class="form-control" id="lastname" name="lastname" placeholder="Enter Last Name"  value="<?php echo $accountinfo['customer_lastname']?>">
  </div>
      </div>
							  <div class="row">
  <div class="col-md-12 mar-b">
    <label for="inputEmail4" class="form-label">Phone Number</label>
    <input type="text" class="form-control" id="phone" name="phone" placeholder="Enter Your Phone" value="<?php echo $accountinfo['customer_phone']?>">
  </div>
							  </div>
      <div class="row">
               <div class="col-md-12">
    <label for="fname" class="form-label">Street Address</label>
    <input type="text" class="form-control" id="streetaddress" name="streetaddress" placeholder="Address"  >
				   <span class="text-danger"><?php echo form_error('streetaddress'); ?></span>
  </div>
  <div class="col-md-12 mar-b">
    <label for="lname" class="form-label">Street Address2</label>
    <input type="text" class="form-control" id="streetaddress2" name="streetaddress2" placeholder="Enter Address2" >
  </div>
      </div>
            <div class="row">
  <div class="col-md-12 mar-b">
  ...
  <div class="col-md-12 mar-b">   
	  ...
	  <input type="checkbox" class="form-check-input" id="default" name="default" checked>
    <label class="form-check-label" for="exampleCheck1">Default Billing Address</label>
  </div>
  <div class="col-md-12 mar-b">    
    <input type="checkbox" class="form-check-input" id="defaultship" name="defaultship" checked>
  ...
  <div class="row">
     <div class="col-12">
      <br>
    <button type="submit" class="btn pinkcss animatedBtn darckBtn btn_style1">Add</button>      
  </div>
  </div>
</form>
                       </div>
