		...
		<div class="loginBottom parallaxBlock triggerBlock">
			...
			<div class="loginFormArea sliderUp50d1">
				...
				<form class="signInForm" method="post" action="<?php echo base_url()?>login">
					<input type="hidden" name="prev" id="prev" value="<?php echo $prevpage?>">
					<div class="text-danger"><?php if($message){  echo $message;  }     
												   ?>
					</div>
					<?php if($this->session->flashdata('message')){?> <p class="text-danger"><?php echo $this->session->flashdata('message'); ?></p><?php }  ?>
					<h5>Sign In</h5>
					...
					<div class="form-check">
						...
						<a class="forgotPassword" href="<?php echo base_url()?>forgot_password">Forgot Password?</a>
					</div>
					<div class="new_loginbar">
						<a href="<?php echo $this->facebook->login_url(); ?>" class="facebookbtn"><img src="<?=base_url()?>facebook.png"> Continue with Facebook</a>
							<a href="<?=base_url()?>googlelogin/login" class="googlebtn"><img src="<?=base_url()?>google.png">Sign in with Google</a>
					</div>
				</form>
				...
				<form class="signUpForm" method="post" action="<?php echo base_url()?>registration">
					...
					<div class="form-group">
						<div class="form-row">
							<div class="col-md-6">
								<input type="text"  name="firstname" id="firstname" class="form-control" placeholder="First name" value="<?php echo set_value('firstname'); ?>" required>
							</div>
							<div class="col-md-6">
								<input type="text" name="lastname" class="form-control" placeholder="Last name" value="<?php echo set_value('lastname'); ?>" required>
							</div>
						</div>
					</div>
					<div class="form-group">
