<<!-- main-content opened -->
						...
						<div class="card mg-b-20">
							<div class="card-header pb-0">
								<div class="justify-content-between" style="display: inline-block;">
									<h3 class="card-title mg-b-2 mt-2"> Page List</h3>
									<i class="mdi mdi-dots-horizontal text-gray"></i>
						             </div>
							<div class="btn_right">
								<a href="<?php echo base_url()?>cms/" class="btn btn-outline-success btn-block"> New Page</a>
							</div>
					                </div>
							<div class="card-body">
    ...
    foreach ($pages as $cat) {
        ...
        ?>
											<tr>
												<td><?php echo $i; ?></td>
												<td ><a href="#"><?php echo $cat->page_name?></a></td>
	...
	<a href="edit/<?php echo $cat->page_id?>"><button class="btn btn-primary btn-icon"><i class="typcn typcn-edit"></i></button></a>
	<a href="delete/<?php echo $cat->page_id?>" onClick="return confirm('Are you sure you want to delete this item')"><button class="btn btn-danger btn-icon"><i class="typcn typcn-delete"></i></button></a>
                </div>
												</td>
											</tr>
