...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="<?php echo $main->skinNew('plugins/iCheck/flat/blue.css') ?>">
    <!-- Morris chart -->
    <link rel="stylesheet" href="<?php echo $main->skinNew('plugins/morris/morris.css') ?>">
    <!-- jvectormap -->
    <link rel="stylesheet" href="<?php echo $main->skinNew('plugins/jvectormap/jquery-jvectormap-1.2.2.css') ?>">
    <!-- Date Picker -->
    ...
    <link rel="stylesheet" href="<?php echo $main->skinNew('plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css') ?>">
...
<script src="<?php echo $main->skinNew('plugins/morris/morris.min.js') ?>"></script>
<!-- Sparkline -->
<script src="<?php echo $main->skinNew('plugins/sparkline/jquery.sparkline.min.js') ?>"></script>
<!-- jvectormap -->
<script src="<?php echo $main->skinNew('plugins/jvectormap/jquery-jvectormap-1.2.2.min.js') ?>"></script>
<script src="<?php echo $main->skinNew('plugins/jvectormap/jquery-jvectormap-world-mill-en.js') ?>"></script>
<!-- jQuery Knob Chart -->
<script src="<?php echo $main->skinNew('plugins/knob/jquery.knob.js') ?>"></script>
<!-- daterangepicker -->
...
<!-- Bootstrap WYSIHTML5 -->
<script src="<?php echo $main->skinNew('plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js') ?>"></script>
<!-- Slimscroll -->
...
<script src="<?php echo $main->skinNew('dist/js/pages/dashboard.js') ?>"></script>
