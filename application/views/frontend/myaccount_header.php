               ...
               <div class="headerRgt">
                  <div class="headerNav">
                        ...
                        <a href="#" class="icon_noti"><img class="headerIcon l" src="https://www.deyar.demoatcrayotech.com/printstore/assets/deyar/skin/img/bell-icon.svg" alt=""><img class="headerIcon d" src="https://www.deyar.demoatcrayotech.com/printstore/assets/deyar/skin/img/bell-icon.svg" alt=""><span class="spancount"><?php echo $commentcount?></span></a>
                          ...
                          <?php } ?>
                           ...
                           <?php foreach ($comments as $co){
                                        ...
                                        $comments=substr($co['order_comments'],0,10);
                                        $comments=$comments."..";
                                        }
                                        else{
                     ...
                     <div class="navItem headerUser dropDown">
                        <a href="<?php echo base_url()?>orders"><img class="headerIcon l" src="https://www.deyar.demoatcrayotech.com/printstore/assets/deyar/skin/img/user-icon-l.svg" alt=""><img class="headerIcon d" src="https://www.deyar.demoatcrayotech.com/printstore/assets/deyar/skin/img/user-icon-d.svg" alt=""></a>
	...
	<?php } ?>			
         ...
         <!-- 
		   ...
		   <!-- 
            <div class="headerSpace"></div> -->
         <br>
     <?php $cval=$this->uri->segment(1);?>
         <div class="contantBlock blockEnd">
            <div class="container">
               <div class="row">
                  <div class="col-md-4 col-lg-3">
                   
                         <div class="account-sticky-container">
      <div class="account-sticky-box">
        <div class="menu-box">
          <ul class="menu">
            <li class="menu-item <?php if ($cval=="myaccount") echo "active";?>" >
              <a href="<?php echo base_url()?>myaccount"> Account Information</a>
            </li>
            <li class="menu-item  <?php if ($cval=="orders"|| $cval=="order_details") echo "active";?>" >
              <a href="<?php echo base_url()?>orders">  My Orders</a>
            </li>
           <!--  <li class="menu-item" data-detect="page-account-loyalty">
              <a href="/account-loyalty">Loyalty Program</a>
            </li> -->
            <li class="menu-item <?php if ($cval=="account_address") echo "active";?>">
              <a href="<?php echo base_url()?>account_address"> Address Book</a>
            </li>
			   <li class="menu-item ">
