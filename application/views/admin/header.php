						...
						<div class="main-header-right">
							<div class="nav nav-item nav-link" id="bs-example-navbar-collapse-1" style="display: none;">
								...
								<div class="dropdown nav-item main-header-notification">
									<a class="new nav-link full-screen-link"  href="#"><i class="fa fa-shopping-cart" aria-hidden="true" style="padding-right:20px"></i></a>
									<div class="dropdown-menu">
										
										<a class="dropdown-item" href="<?php echo base_url()?>estimate/new_cart"><i class="fa fa-shopping-cart"></i> Estimate cart</a>
										
										<a class="dropdown-item" href="<?php echo base_url()?>ad_order/new_cart"><i class="fa fa-shopping-cart"></i> New Order cart</a>
