...
<div class="successfully_icon">
	<i class="fas fa-check-circle"></i>
        ...
        <div>
          <!--   <a href="#" class="btn pinkcss animatedBtn darckBtn btn_style2 width175" style=""><span> Continue Shopping</span></a> -->
          
          <?php if($this->uri->segment(2)=="new_estimate"){?>
           <a href="<?php echo base_url(); ?>estimate/new_cart" class="btn pinkcss animatedBtn darckBtn btn_style1 width175" style=""><span> Go To Cart</span></a>
           <?php } else {?>
...
<div id="updatecart_popup" class="modalstle" style="display: none;">
    <!-- Modal content -->
    <div class="modal-contentstyle">
        <div>
           <!--  <strong style="font-size: 16px;color: #21293C;"> </strong> <span class="close">×</span> -->
<div class="successfully_icon">
	<i class="fas fa-check-circle"></i>
        ...
        <p style="margin-top: 20px;margin-bottom: 20px;color: #21293C; font-size: 15px;"> Successfully updated order with new item </p>
        <div>
         <!--    <a href="#" class="btn pinkcss animatedBtn darckBtn btn_style2 width175" style=""><span> Continue Shopping</span></a> -->
            
            <a href="<?php echo base_url(); ?>ad_order" class="btn pinkcss animatedBtn darckBtn btn_style1 width175" style=""><span> Go To Order Page</span></a>
        </div>
    </div>
</div>
<div id="updateitemorder_popup" class="modalstle" style="display: none;">
    <!-- Modal content -->
    <div class="modal-contentstyle">
        <div>
           <!--  <strong style="font-size: 16px;color: #21293C;"> </strong> <span class="close">×</span> -->
<div class="successfully_icon">
	<i class="fas fa-check-circle"></i>
        ...
        <p style="margin-top: 20px;margin-bottom: 20px;color: #21293C; font-size: 15px;"> Successfully updated items on order </p>
        <div>
          <!--   <a href="#" class="btn pinkcss animatedBtn darckBtn btn_style2 width175" style=""><span> Continue Shopping</span></a> -->
...
.btn_style2 {
    ...
    border: 2px solid #ec1d8c !important;
    font-weight: 500;
}
</style>
 <!-- JS -->
