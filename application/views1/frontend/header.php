			...
			<div class="headerRgt">
				<div class="headerNav">
					...
					<div class="navItem headerUser dropDown">
						<a href="#"><img class="headerIcon l" src="<?php echo $main->front_end_skin('img/user-icon-l.svg')?>" alt=""><img class="headerIcon d" src="<?php echo $main->front_end_skin('img/user-icon-d.svg')?>" alt=""></a>
	...
	<div class="mainMenu">
		<div class="menuArea">
			<div>
				...
				<div class="menuBtn">
					<a href="#" class="btnFlip" data-back="Shop Now" data-front="Shop Now"></a>
					<div class="clearfix"></div>
					<a href="login" class="btnFlip" data-back="Login" data-front="Login"></a>
					<div class="clearfix"></div>
