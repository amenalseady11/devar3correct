                  ...
                  <div class="col-md-8 col-lg-9">
                    <div class="box_address">
                       <h4>Address Book    <div align="right"><a href="new_address" class="btn btn-primary" role="button">Add New Address</a></div></h4>
  <div class="row">
...
<?php echo $addressbilling['country_code']?><br>
<a href="tel:580760706">  <?php echo $addressbilling['phone_number']?> </a>

                    </address>
                </div>
                <div class="box-actions">
                    <a class="action edit btn animatedBtn darckBtn" href="editaddress/<?php echo $addressbilling['id']?>">
...
<?php echo $addressshipping['country_code']?><br>
<a href="tel:<?php echo $addressshipping['phone_number']?>">  <?php echo $addressshipping['phone_number']?> </a>

                    </address>
                </div>
                <div class="box-actions">
                    <a class="action edit btn animatedBtn darckBtn" href="editaddress/<?php echo $addressshipping['id']?>">
                        <span>Change Address</span>
                    </a>
                </div>
            </div>
			...
			<?php foreach ($alladdress as $add)	{
				...
				?>			
                            ...
                            <td data-th="Street Address" class=" streetaddress"><?php echo $add[address] ?></td>
                                <td data-th="Country" class=" country"><?php echo $add[country_code] ?></td>
                           ...
                           <td data-th="Zip/Postal Code" class=" zip"><?php echo $add[zip_code] ?></td>
                            ...
                            <td data-th="Actions" class=" actions">
                                ...
                                <a class="action delete" href="deleteaddress/<?php echo $add['id']?>" role="delete-address" data-address="6"><span>Delete</span></a>
                            </td>
                        </tr>
